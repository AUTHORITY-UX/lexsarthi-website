...
T = TypeVar("T", bound="LegalResearchRequest")
...
class LegalResearchRequest:
    ...
    Attributes:
        ...
        max_sources (int | Unset):  Default: 5.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        legal_research_request.additional_properties = d
        return legal_research_request
